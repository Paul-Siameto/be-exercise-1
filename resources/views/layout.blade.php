...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{url('admin/setting')}}" data-target="#collapseThree"
                    aria-expanded="true" aria-controls="collapseThree">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Settings</span>
                </a>
                <!--<div id="collapseThree" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    
                        <a class="collapse-item" href="{{url('admin/setting')}}">Setting</a>
